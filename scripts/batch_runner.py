...
DEFAULT_EXPERIMENTS = [
    ...
    {
        "name": "frequency_clustering_krum",
        "attack": "frequency",
        "detection": "clustering_detection",
        "defense": "krum",
        "client-defense": "none",
    ...
    {
        "name": "badnets_cosine_krum",
        "attack": "badnets",
        "detection": "cosine_detection",
        "defense": "krum",
        "client-defense": "none",
        "num-server-rounds": 10,
        "poison-rate": 0.3,
